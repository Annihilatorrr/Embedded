...
public:
	void init()
	{
		...
		GPIOA->MODER |=	GPIO_MODER_MODER4_0 | GPIO_MODER_MODER5_1 |	GPIO_MODER_MODER6_1 | GPIO_MODER_MODER7_1; //output, alt, alt, alt

		GPIOA->OTYPER &= ~ (GPIO_OTYPER_OT_4 | GPIO_OTYPER_OT_5 | GPIO_OTYPER_OT_6 | GPIO_OTYPER_OT_7); // push-pull, push-pull, push-pull, push-pull
		GPIOA->OSPEEDR &= ~	(GPIO_OSPEEDER_OSPEEDR4 | GPIO_OSPEEDER_OSPEEDR5 | GPIO_OSPEEDER_OSPEEDR6 |	GPIO_OSPEEDER_OSPEEDR7);

		GPIOA->OSPEEDR |= GPIO_OSPEEDER_OSPEEDR4_0 | GPIO_OSPEEDER_OSPEEDR5_0 | GPIO_OSPEEDER_OSPEEDR6_0 | GPIO_OSPEEDER_OSPEEDR7_0; // high-speed
		...
		GPIOA->AFR[0] |= (5 << 4*5) | (5 << 4*6) | (5 << 4*7); // AF5 for SPI1 NSS on PA5,PA6,PA7
