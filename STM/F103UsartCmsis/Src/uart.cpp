...
extern uint8_t		uart1_rx_buf[U1RXBUF_SIZE]; 							// ����� ��� ����� ���������
...
void USART1_IRQHandler(void) {
	if ((USART1->SR & USART_SR_RXNE) != 0) {								// ���� ������ ���-�� �� USART
		...
		uart1_rx_buf[uart1_rx_bit] = uart1_rx_data; 						// �������� �������� ���� � �����
		if (uart1_rx_bit != 64) uart1_rx_bit++; else uart1_rx_bit=0;		// ���������� ������� ������ ������
		if (uart1_rx_data == 0x0D) uart1_rx_status = CHEK_MSG;				// ���� ������ ����� ������� <CR>=0x0D=13 (<LF>=0x0A=10)
	}
}
...
void initUART1(void) {
	...
	// ����� �������� ������� �����, ��������� ����� � ����������������� ������� ��������� � �������� 0x9c5
	// 9600 baud USARTDIV = 8000000 / (16*9600) = 52.08 = 0x341 (8 MHz - ������� ���� APB)
	// 9600 baud USARTDIV = 24000000 / (16*9600) = 156.25 = 0x9c4 (24 MHz - ������� ���� APB)
	// 9600 baud USARTDIV = 36000000 / (16*9600) = 234.375 = 0x9c4 (36 MHz - ������� ���� APB)
	// 115200 baud USARTDIV = 24000000 / (16*115200) = 13.0 = 0x0d0 (24 MHz - ������� ���� APB)
	USART1->BRR = 0x1d4d;
//	USART2->BRR = 0xea7;
//	USART3->BRR = 0xea7;
 	// ��������� ����������, ������� � USART
...
//	NVIC_SetPriority(USART1_IRQn, 1);										// ��������� ���������� 1
}
